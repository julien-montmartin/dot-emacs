...
Mode qui permet de visualiser la 80^e colonne (ou n'importe quelle autre). Pratique, mais pas sans inconvénients. Mes préférés :
...
On veut la mise en évidence de syntaxe dans les blocs de code
...
À l'export, on se contente de trois niveaux de titres, et au-delà, on fait des listes
#+BEGIN_SRC emacs-lisp :tangle yes
  (setq org-export-headline-levels 3)
#+END_SRC

À l'export, on ne veut pas qu'Org ajoute un auteur (valorisé avec le nom de l'utilisateur)

#+BEGIN_SRC emacs-lisp :tangle yes
  (setq org-export-with-author nil)
#+END_SRC

À l'export, on ne veut pas que les titres des sections soient numérotés
